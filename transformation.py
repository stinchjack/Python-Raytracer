...
class Transform:
	...
	def set_options(self, options):
		...
		if rotatematrix!=None and scalematrix==None:
			...
			self.__inverse_matrix = self.__matrix.inversed() #deepcopy(rotatematrix.inversed()) #* deepcopy(scalematrix.inversed())
		elif scalematrix!=None and rotatematrix==None:
	...
	def transform(self, ray):
		...
		"""
		if self.__no_transform: return ray
	...
	def inverse_transform(self, normal, translate=False):
		...
		"""
		if self.__no_transform: return normal
